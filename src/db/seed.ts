...
async function seed() {
  ...
  await query(`
    ...
    ('11111111-0011-0011-0011-000000000011','Girma Desta','girma.desta@bidlow.et','+251932345678',$1,'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop&crop=face','moderator','active',1100,40),
